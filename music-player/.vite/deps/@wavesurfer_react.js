...
function s(t3, e3) {
  ...
  for (const [t4, n3] of Object.entries(e3)) if ("children" === t4 && n3) for (const [t5, e4] of Object.entries(n3)) e4 instanceof Node ? i3.appendChild(e4) : "string" == typeof e4 ? i3.appendChild(document.createTextNode(e4)) : i3.appendChild(s(t5, e4));
  ...
  return t(this, void 0, void 0, (function* () {
    ...
    return (function(e4, i4) {
      t(this, void 0, void 0, (function* () {
        ...
        let r3 = 0, o3 = 0;
        const a3 = (e5) => t(this, void 0, void 0, (function* () {
          r3 += (null == e5 ? void 0 : e5.length) || 0;
          const t3 = Math.round(r3 / n4 * 100);
          i4(t3);
        })), h2 = () => t(this, void 0, void 0, (function* () {
          if (o3++ > 1e5) return void console.error("Fetcher: Maximum iterations reached, stopping read loop");
          let t3;
          try {
            t3 = yield s3.read();
          } catch (t4) {
...
var a = class extends e {
  ...
  setSrc(t3, e3) {
    ...
    if (i3 && this.media.removeAttribute("src"), s2 || t3) try {
      this.media.src = s2;
    } catch (e4) {
      this.media.src = t3;
    }
...
var h = class _h extends e {
  ...
  initDrag() {
    this.dragUnsubscribe || (this.dragUnsubscribe = (function(t3, e3, i3, s2, n3 = 3, r3 = 0, o3 = 100) {
      if (!t3) return () => {
      };
  ...
  renderMultiCanvas(t3, e3, i3, s2, n3, r3) {
    ...
    const u3 = (i4) => {
      ...
      c3[i4] = true;
      const o4 = i4 * d2;
      let a4 = Math.min(l3 - o4, d2);
      if (e3.barWidth || e3.barGap) {
        const t4 = e3.barWidth || 0.5, i5 = t4 + (e3.barGap || t4 / 2);
        a4 = Math.floor(a4 / i5) * i5;
      }
      if (a4 <= 0) return;
      const h2 = t3.map(((t4) => {
...
var u = class _u extends a {
  ...
  constructor(t3) {
    ...
    super({ media: e3, mediaControls: t3.mediaControls, autoplay: t3.autoplay, playbackRate: t3.audioRate }), this.plugins = [], this.decodedData = null, this.stopAtPosition = null, this.subscriptions = [], this.mediaSubscriptions = [], this.abortController = null, this.options = Object.assign({}, c, t3), this.timer = new l();
    ...
    Promise.resolve().then((() => {
      ...
      (s2 || t4 && e4) && this.load(s2, t4, e4).catch(((t5) => {
        console.error("WaveSurfer initial load error:", t5);
      }));
    }));
  }
  ...
  initRendererEvents() {
    ...
    })));
    {
      ...
      const e3 = this.renderer.on("drag", ((e4) => {
        ...
        let i3;
        this.renderer.renderProgress(e4), clearTimeout(t3), this.isPlaying() ? i3 = 0 : true === this.options.dragToSeek ? i3 = 200 : "object" == typeof this.options.dragToSeek && void 0 !== this.options.dragToSeek && (i3 = this.options.dragToSeek.debounceTime), t3 = setTimeout((() => {
          this.seekTo(e4);
        }), i3), this.emit("interaction", e4 * this.getDuration()), this.emit("drag", e4);
      }));
  ...
  loadAudio(e3, s2, n3, r3) {
    return t(this, void 0, void 0, (function* () {
      var t3;
      if (this.emit("load", e3), !this.options.media && this.isPlaying() && this.pause(), this.decodedData = null, this.stopAtPosition = null, null === (t3 = this.abortController) || void 0 === t3 || t3.abort(), this.abortController = null, !s2 && !n3) {
        ...
        s2 = yield o.fetchBlob(e3, i3, t4);
        const n4 = this.options.blobMimeType;
        n4 && (s2 = new Blob([s2], { type: n4 }));
      }
      this.setSrc(e3, s2);
  ...
  play(e3, i3) {
    ...
    return t(this, void 0, void 0, (function* () {
      ...
      const t3 = yield s2.play.call(this);
      return null != i3 && (this.media instanceof d ? this.media.stopAt(i3) : this.stopAtPosition = i3), t3;
    }));
  }
  playPause() {
    return t(this, void 0, void 0, (function* () {
...
function p(t3) {
  ...
  const n3 = i2(e3, (function(t4, e4) {
    ...
    const [e4, n4] = (0, import_react.useState)(false), [s3, i3] = (0, import_react.useState)(false), [a3, u3] = (0, import_react.useState)(false), [f2, l3] = (0, import_react.useState)(0);
    return (0, import_react.useEffect)((() => {
      if (!t4) return;
      const e5 = [t4.on("load", (() => {
    ...
    }), [t4]), (0, import_react.useMemo)((() => ({ isReady: e4, isPlaying: s3, hasFinished: a3, currentTime: f2 })), [s3, a3, f2, e4]);
  })(n3);
